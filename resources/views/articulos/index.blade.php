                ...
                @foreach ($chunk as $articulo)
                    <div class="col-md-3 publicaciones">
                        <div class="p-2 w-100 h-100 libro-card">
                            ...
                            <a href="#" class="btn btn-danger btn-sm active" data-toggle="modal"
                                data-target="#modalArticulo-{{ $articulo->id }}" role="button" aria-pressed="true">Ver
                                Más</a>
                        </div>
                    </div>
                @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @foreach ($articulo->archivos()->where('activo', 1)->get() as $archivo)
                                        <div class="file mb-1">
                                            <a target="_blank"
                                                href="{{ url('storage/files/' . $archivo->path) }}">{{ $archivo->path }}</a>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
