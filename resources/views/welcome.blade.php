...
@endphp
                        <a href="{{route('eventos.show',$evento)}}" class="block-20 d-flex align-items-end" style="background-image: url('{{$url}}');">
				...
				setlocale(LC_TIME, 'es_MX.UTF-8', 'esp');
                        ...
                        <div class="text bg-white p-4">
                            <h1 class="heading  text-center border-bottom pb-3 mb-3"><a href="{{route('eventos.show',$evento)}}"><b>{{substr($evento->titulo,0,109)}}</b></a></h1>
                        ...
                        <div class="features-item">
                            ...
                            <div class="somos-extension container">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="extension-element col-md-6 col-lg-3">
                                        <a target="_blank" href="http://cmarti.cucsh.udg.mx/" class="extension-container bg-extension1">
                                            <div>
...
<div class="extension-element col-md-6 col-lg-3">
                                        <a class="extension-container bg-extension2" target="_blank" href="http://desmos.cucsh.udg.mx/eventos">
                                            <div>
...
$url = 'https://www.youtube.com/embed/'.explode('youtu.be/',$divulgacion->link)[1];
}else{
